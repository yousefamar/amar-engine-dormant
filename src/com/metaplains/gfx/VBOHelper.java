...
public class VBOHelper {
	...
	public static FloatBuffer createVertexBuffer(int vertexCount) { 
		return BufferUtils.createFloatBuffer(8 * vertexCount); //pos4, col4
	}
	
	public static IntBuffer createIndexBuffer(int indexCount) { 
		return BufferUtils.createIntBuffer(indexCount);
	}
